...
public class FlutterSplashView implements PlatformView, MethodChannel.MethodCallHandler, PluginRegistry.RequestPermissionsResultListener, SplashADListener{
...
//    private Handler handler = new Handler(Looper.getMainLooper());
    ...
    public FlutterSplashView(Context context, BinaryMessenger messenger, int id, Map<String, Object> params) {
        if(PluginSettings.APP_ID == null) {
            throw new IllegalStateException("App Id must be configured before creating ad view");
        }
        this.methodChannel = new MethodChannel(messenger, PluginSettings.SPLASH_VIEW_ID + "_" + id);
        this.methodChannel.setMethodCallHandler(this);
        this.posId = (String)params.get("posId");
        if(params.containsKey("minSplashTimeWhenNoAD")) {
            this.minSplashTimeWhenNoAD = (int) params.get("minSplashTimeWhenNoAD");
        }
