...
class _SplashWidgetState extends State<SplashWidget> {
  ...
  void initState() {
    ...
    AdnetQqPlugin.config(appId: config['appId'] as String, requestReadPhoneState: 0, requestAccessFineLocation: 0, requestIDFA: 1, adChannel: 1).then((_) {
      SplashAd(config['splashPosId'] as String, backgroundImage: config['splashBackgroundImage'] as String, adEventCallback: (event, _) {
        print('$event, $_');
